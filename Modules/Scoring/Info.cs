    ...
    public class Info : ModuleBase<SocketCommandContext> {
        ...
        Embed reaccs = new EmbedBuilder().WithColor(Color.Blue).WithAuthor("Reactions")
           .WithDescription("p*command [mandatory] (optional)")
            ...
            .AddField("p*choose [CHOICE] | [CHOICE] | ...", "Make Primbot choose for you!", true)
        ...
        public async Task GetInfo() {
            ...
            await ReplyAsync(
                ...
                "***Version Number:*** 2.0" +
                "***Version Release Date:*** 2019/1/21" +
                "***Written in:*** C#\n" +
                "***Host:*** Local\n" +
                "***Bot Token:*** u wish\n" +
                "***Bot Invite Link:*** Not yet public \n");
        }
        ...
        public async Task Help([Remainder] string args = null) {
            ...
            Server.Channel.AddReactions(msg, new List<Emote> { blueUno, blackUno, uwu, chick, gear });
            Discord.Emote reaccType = null;
            for (int i = 0; i < 150; i++) {
                var reaction = Server.Channel.GetFirstReaction(msg, new List<Emote> { blueUno,
                    blackUno, uwu, chick, gear }, Context.User.Id);
                if(reaction != null) {
